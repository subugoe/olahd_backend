...
public class ElasticsearchService {
     ...
     * @return
     */
    public ResultSet facetSearch(String searchterm, int limit, int offset, boolean extended,
            Boolean isGt, boolean metadatasearch, boolean fulltextsearch, String sort,
            String[] field, String[] value) {

        ElasticQueryHelper util = new ElasticQueryHelper(searchterm, limit, offset, extended,
        ...
        try {
            ...
            return util2.responseToResultSet(response, searchterm, metadatasearch, fulltextsearch, offset, limit);
        } catch (IOException e) {
            throw new ElasticServiceException("Error executing search request", e);
        }
    }
